...
pub struct Arg {
	...
	/// 'files' you would set `number_of_values = 3`, and this argument
	/// wouldn't be satisfied unless the user provided 3 and only 3 values.
	///
	/// **NOTE:** Does *not* require `multiple_occurrences = true` to be set.
	/// Setting `multiple_occurrences = true` would allow `-f <file> <file>
	...
	/// For example, if you had a -f `<file>` argument where you wanted at
	/// least 2 'files', you would set `minValues: 2`, and this argument would
	/// be satisfied if the user provided, 2 or more values.
...
impl Config {
	...
	/// auto-generated help information. This is often used for header
	/// information.
	pub fn before_help(&self) -> Option<&String> { self.before_help.as_ref() }

	/// Adds additional help information to be displayed in addition to
	/// auto-generated help. This information is displayed after the
	/// auto-generated help information. This is often used to describe how to
	/// use the arguments, or caveats to be noted.
	pub fn after_help(&self) -> Option<&String> { self.after_help.as_ref() }
}
